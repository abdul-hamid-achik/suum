...
ActiveRecord::Schema.define(version: 2021_09_26_204817) do
  ...
  create_table "segments", force: :cascade do |t|
    ...
    t.index ["transmission_id"], name: "index_segments_on_transmission_id"
  end
  ...
  add_foreign_key "segments", "transmissions"
